---
title: "Package ID Specifications"
mode: "wide"
sidebarTitle: "1.7 - Package ID Specifications"
---

This section is included here because it directly builds upon the previous topic, but it also serves a broader purpose. It showcases the full extent of Cargo's power in locating <u>packages specific versions, whether online or offline</u>, and is intended to act primarily as a reference guide for custom configurations. It is entirely acceptable—and even recommended—to simply <u>skim this section</u> for now and move on.
